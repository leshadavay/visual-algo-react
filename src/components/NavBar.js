...
const NavBar = ({ children, darkMode, toggleDarkMode }) => {
  return (
    <>
      {/*
      ...
      */}
      <div className="min-h-full">
        <Disclosure as="nav" className="bg-slate-600 dark:bg-gray-800">
          {({ open }) => (
            <>
                        ...
                        <a
                          ...
                          className={classNames(
                            item.current
                              ...
                              : " text-gray-300 hover:bg-gray-500 dark:hover:bg-gray-700 hover:text-white",
